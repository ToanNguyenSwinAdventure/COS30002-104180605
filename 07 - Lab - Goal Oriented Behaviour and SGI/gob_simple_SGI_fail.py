...
# actions = {
#     'get raw food': { 'Hunger': -30, 'Unhappiness':20},
#     'get snack': { 'Hunger': -20, 'Unhappiness': -20 },

#     'sleep in bed': { 'Sleepy': -100, 'Energy': 60 },
#     'sleep on sofa': { 'Sleepy': -60, 'Energy': 45 },
#     'play football': {'Energy': -60, 'Unhappiness': -40}
# }
...
actions = {
    'get raw food': { 'Hunger': -50, 'Unhappiness':50},
    'get snack': { 'Hunger': -20},
}
